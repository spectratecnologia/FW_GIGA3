...
void USBH_USR_UnrecoveredError (void)
{
  ...
  //printf((void *)MSG_MSC_UNREC_ERROR);
}
...
void USBH_USR_OverCurrentDetected (void)
{
  ...
  //displayErrorMessage("Erro: Desconecte", "o pendrive ", 3000, PRIORITY_2);
}
...
{
  /*
   * At this point the USB Device plugged
   * has already been initialized
   *
   */
  if(hostInitState == HOST_INIT_STATE_RUNNING)
  {
    hostInitState = HOST_INIT_STATE_DONE;
  }
  return(0);
}
