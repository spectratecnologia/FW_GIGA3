...
void onCAN1ReceiveInterrupt_MPX(CanRxMsg rxMessage, MsgId msgId)
{
...
void onCAN1ReceiveInterrupt_PTC24(CanRxMsg rxMessage, MsgId msgId)
{
...
void onCAN1ReceiveInterrupt_PTC16(CanRxMsg rxMessage, MsgId msgId)
{
...
uint16_t getMpxAnalogMemoryAddress(uint8_t mpxIndex, uint8_t analogValue)
{
