...
void activePP10Aports(uint8_t, FunctionalState_MPXports);
void activePP10AportX(uint8_t, uint8_t, uint8_t, FunctionalState_MPXports);
void activeBIDIports(uint8_t, FunctionalState_MPXports);
void activeLODINports(uint8_t, FunctionalState_MPXports);
...
void activePP10Aports(uint8_t portx, FunctionalState_MPXports state)
{
	if (portx == 0)
...
void activePP10AportX(uint8_t pinH, uint8_t pinL, uint8_t portx, FunctionalState_MPXports state)
{
...
/* Active BIDI ports ---------------------------------------------------------*/
void activeBIDIports(uint8_t portx, FunctionalState_MPXports state)
{
...
/* Active LODIN ports --------------------------------------------------------*/
void activeLODINports(uint8_t portx, FunctionalState_MPXports state)
{
	uint32_t position=0x00000001;
...
void turningOffMpxEmergencyMode(void)
{
	...
	sendCanPacket(CAN1, CAN_COMMAND_BROADCAST, CAN_BROADCAST_KEY_STATE_MASK, 0x20, 0x00, &data[0], 8);
}
